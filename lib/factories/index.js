...
class PowerPointFactory {
    ...
    async loadFromRawFileData(data) {
        ...
        const keys = Object.getOwnPropertyNames(zip.files);
    ...
    clearContent() {
        Object.getOwnPropertyNames(this.content).forEach(key => {
    ...
    extractObjectsFromContent(content) {
        ...
        Object.getOwnPropertyNames(slideInformation).forEach(slideName => {
    ...
    getSlide(slideName) {
        if (!Object.hasOwnProperty.call(this.slides, slideName)) {
            throw new Error(`Slide name doesn't exist in PowerPointFactory.getSlide(): '${slideName}' `);
        }
    ...
    moveSlide(sourceSlideNum, destinationSlideNum) {
        ...
        if (!Object.hasOwnProperty.call(this.slides, sourceSlideName)) {
            throw new Error(`Source slide number does not exist in PowerPointFactory.moveSlide(): ${sourceSlideNum}`);
        }

        if (!Object.hasOwnProperty.call(this.slides, destinationSlideName)) {
    ...
    rebuild() {
        ...
        Object.getOwnPropertyNames(this.slides).forEach(slideName => {
